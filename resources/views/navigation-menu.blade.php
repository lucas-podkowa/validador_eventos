<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 ">
            <div class="flex ">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('procesar_aprobaciones') }}"
                        :active="request()->routeIs('procesar_aprobaciones')">
                        {{ __('Aprobaciones') }}
                    </x-nav-link>
                </div>
                @endrole
                ...
                <div x-data="{ adminOpen: false }" class="hidden sm:ms-10 sm:flex relative">
                    ...
                    <div x-show="adminOpen" @click.away="adminOpen = false"
                        ...
                        <div class="py-1">
                            <x-dropdown-link href="{{ route('indicadores') }}">{{ __('Indicadores') }}</x-dropdown-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @role('Administrador')
            <x-responsive-nav-link href="{{ route('registrar_evento') }}"
                :active="request()->routeIs('registrar_evento')">
                {{ __('Registrar Evento') }}
            </x-responsive-nav-link>
            ...
            @role('Administrador|Revisor|Gestor')
            <x-responsive-nav-link href="{{ route('procesar_aprobaciones') }}"
                :active="request()->routeIs('procesar_aprobaciones')">
                {{ __('Aprobaciones') }}
            </x-responsive-nav-link>
            @endrole
